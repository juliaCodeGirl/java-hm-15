...
class IssueManagerTest {
    ...
    private Issue issue1 = new Issue(1, true, "Yuliya", 3, new HashSet<>(Arrays.asList("label1", "label2", "label3")), new HashSet<>(Arrays.asList("juliaCodeGirl", "mari", "peter")));
    private Issue issue2 = new Issue(2, false, "Yuliya", 10, new HashSet<>(Arrays.asList("label1", "label2", "label5")), new HashSet<>(Arrays.asList("juliaCodeGirl", "anton", "peter")));
    ...
    public class Empty {
        ...
        void shouldReturnEmptyWhenFindByAssignee() {
            Collection<Issue> expected = new ArrayList<>();
            Collection<Issue> actual = manager.findByAssignee(new HashSet<String>(Arrays.asList("juliaCodeGirl")));
            assertEquals(expected, actual);
        }
    }
